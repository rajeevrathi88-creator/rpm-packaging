...
import type { LeadId as _LeadId, SubmitLeadResult as _SubmitLeadResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitLead(arg0: LeadRequest): Promise<SubmitLeadResult> {
        if (this.processError) {
            try {
                const result = await this.actor.submitLead(arg0);
                return from_candid_SubmitLeadResult_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_SubmitLeadResult_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SubmitLeadResult): SubmitLeadResult {
